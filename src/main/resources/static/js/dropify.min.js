    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                imgFileExtensions: ["png", "jpg", "jpeg", "gif", "bmp", "jfif"],
                ...
                tpl: {
                    ...
                    message: '<div class="dropify-message"><span class="fa fa-cloud-upload" /> <p>{{ default }}</p></div>',
                    preview: '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
                    filename: '<p class="dropify-filename"><span class="fa fa-cloud-upload"></span> <span class="dropify-filename-inner"></span></p>',
